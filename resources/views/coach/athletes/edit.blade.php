                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Athlete Details</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('coach.athletes.update', $athlete) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <a href="{{ route('coach.list') }}" class="btn btn-secondary">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
