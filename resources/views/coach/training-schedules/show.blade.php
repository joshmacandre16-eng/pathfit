            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('coach.training-schedules.index') }}">Training Schedules</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('coach.training-schedules.edit', $trainingSchedule) }}" class="btn btn-warning btn-sm">Edit</a>
                                <a href="{{ route('coach.training-schedules.index') }}" class="btn btn-secondary btn-sm">Back to List</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <dl class="row">
